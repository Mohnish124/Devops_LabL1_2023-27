...
This project demonstrates a distributed Jenkins pipeline. The work is delegated by the Jenkins Master to separate agent nodes for compilation and testing.
