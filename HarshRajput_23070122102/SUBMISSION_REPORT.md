...
**Student Name:** Harsh Rajput
**PNR:** 23070122102  
**Subject:** DevOps Lab  
**Batch:** 2023-27  
**Submission Folder:** `HarshRajput_23070122102/`  
**QA Date:** Sep 1, 2026  
...
2. **Push Repository to GitHub:** Push the `HarshRajput_23070122102/` folder to your remote GitHub repository (`git push -u origin main`).

---

## 6. Final Submission Checklist

- [x] Folder name strictly follows `HarshRajput_23070122102`.
